...
import com.suleyman.kotlinmaps.databinding.ActivityMapsBinding
import com.suleyman.kotlinmaps.model.Place
import com.suleyman.kotlinmaps.roomdb.PlaceDao
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.suleyman.kotlinmaps", MODE_PRIVATE)
        trackBoolean = false
